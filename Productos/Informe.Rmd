...
Si bien estas son las prácticas deseadas, en la realidad esto se vuelve un poco más complejo. En los últimos años se ha normalizado el término "colapso" en los servicios de urgencia, ya sea por períodos muy marcados de enfermedades respiratorias o por la pandemia en últimos años. Sin embargo, no hay una definición muy clara sobre lo que entendemos por colapso. ¿Muere gente sin ser atendida? ¿No hay insumos para realizar una buena atención? ¿No hay personal? ¿Hay mucho tiempo de espera? Darle una respuesta a estas interrogantes pareciera ser nuestro primer paso para buscar una mejora. De todos modos, debemos entender que no hay una solución fácil, ya que incluso en países de la Organización para la Cooperación y el Desarrollo Económicos (OCDE), que cuentan con los mejores índices de salud, aún existen problemas con las atenciones de urgencia.**(1)**.
...
```
En el gráfico anterior se puede observar que Chile se sitúa en tercer lugar, con una tasa de tasa de 57,1 consultas en las Unidades de Emergencia Hospitalarias por cada 100 habitantes, mientras que la media es de 30,8. Además si tomamos en cuenta los últimos Indicadores Básicos de Salud publicados por el Ministerio de Salud, es visible que las atenciones de urgencia han superado de manera progresiva a las atenciones otorgadas por la red primaria de salud, una situación alarmante si nuestro objetivo es un sistema de salud de carácter preventivo con énfasis en las redes primarias.
...
Para realizar el informe se utilizaron los software RStudio y Excel. En Rstudio se realizó un análisis descriptivo, en el que se cruzaron las bases de datos de los diferentes años.
...
```
De la figura anterior es observable que las llegadas a urgencia por causas atribuídas al sistema circulatorio se mantuvo con valores similares entre los años 2014 y 2019. Sin embargo, en el año de 2020 a raíz de la llegada de la primera ola de Covid-19 a nuestro país, se visualiza una caída muy abrupta en las atenciones de urgencia. Esto podría tener una incidencia en que enfermedades con un gran indice de mortalidad, se hayan dejado de atender. De manera de visualizar esto, en las próximas figuras evaluaremos la evolución por semana estadística de las urgencias atribuídas por accidentes cardiovasculares e Infarto agudo al miocardio.
...
- En un año normal la composición de las llegadas a urgencia se componen de 5 causas generales. Destacan entre ellas, las enfermedades respiratorias con una gran proporción y las causas atribuídas al sistema circualtorio con un gran índice de mortalidad.

- Las urgencias atribuídas al sistema respiratorio tienen un valor máximo muy marcado en las últimas semanas de otoño y las primeras semanas de invierno.

- El colapso ocurrido en el año 2020 no solo afecto las llegadas a urgencia atribuídas al sistema respiratorio, sino que también afecto las causas del sistema circulatorio. Destaca entre ellas, una caída del 21% del total de atenciones de urgencia atribuídas a accidentes vasculares entre las semanas 12 y 35.
